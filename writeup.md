...
I used a combination of color and gradient thresholds to generate a binary image (thresholding steps in section 4 of "./P2.ipynb").  Here's an example of my output for this step.
